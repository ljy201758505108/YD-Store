...
<script>
		var data = [
					...
					items:[
						...
						{name:"账号管理",index:"/ssm/platform/accountManage.action"}],
					},
					{name:"商家管理",
					icon:"glyphicon glyphicon-th",
					items:[
						{name:"商家信息查询",index:"/ssm/platform/businessManagePage.action"},
						{name:"商家店铺查询",index:"./html/b2.html"}],
					},
					{name:"店铺管理",
					icon:"glyphicon glyphicon-file",
					items:[
						{name:"店铺查询",index:"./html/c1.html"},
						{name:"入驻申请",index:"./html/c2.html"},
						{name:"推广申请",index:"./html/c3.html"}],
					},
					{name:"用户管理",

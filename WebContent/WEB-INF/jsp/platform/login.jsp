			...
			<div class="log_in">
				<div class="row">
					...
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
						...
						<span class="tel">账号：</span><input type="text" id="accname" class="form-control"><br>
						<span class="pwd">密码：</span><input type="password" id="pwd"  class="form-control"><br>
						</div>
						
						<input type="checkbox" id="isRemember">记住我
						<button id="loginBtn">登录</button><span>&nbsp;&nbsp;&nbsp;&nbsp;没有账号？&nbsp;<a href="/ssm/user/registerPage.action">立即注册</a></span>
			...
			$.ajax({
				...
				success:function(res){
					...
					if(res.code == 1000){
						...
						if(res.data == 1){
							//跳转到平台首页
							window.location.href="/ssm/platform/index.action";
						}else{
